...
router.get('/google/connect', requireClerkUser, integrationController.connectGoogle);
...
router.get('/github/connect', requireClerkUser, githubController.connectGithub);
