...
${summarySection}
${artifactSection}
Rules: No file generation for normal questions. Understand "that/this/it" from conversation. Call search_project_knowledge at most once. If it returns nothing useful, answer immediately from the compact project context (tech stack, sessions, milestones) — do not search again. Today: ${new Date().toISOString().split('T')[0]}.`
        };
    }
